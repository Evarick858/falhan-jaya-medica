...
// Store configuration - load from localStorage or use defaults
const DEFAULT_STORE = {
...
function handleAddProduct(e) {
    ...
    const newProduct = {
        ...
        image: sanitizeImageUrl(document.getElementById('productImage').value) || `https://via.placeholder.com/300x300/2563eb/ffffff?text=${encodeURIComponent(document.getElementById('productName').value)}`,
...
function handleEditProduct(e) {
    ...
    products[productIndex] = {
        ...
        image: sanitizeImageUrl(document.getElementById('editProductImage').value) || oldImage,
